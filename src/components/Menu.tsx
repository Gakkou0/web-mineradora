...
export default function Menu({ setPagina }: MenuProps) {
  const baseButton = 'rounded-2xl border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-700 shadow-sm transition hover:bg-slate-100 hover:text-slate-900'
